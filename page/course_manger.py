...
class Coursemanger_page(Page, PageSelect):
    ...
    create_bt = PageElement(xpath='//*[@id="root"]/div/div[2]/div[2]/div[2]/div/span')  # 创建课程按钮
    create_live_bt = PageElement(xpath='/html/body/div[3]/div/div/div/div[2]/div/div/div/div[1]')  # 创建直播课
    search_bt = PageElement(xpath='//*[@id="root"]/div/div[2]/div[2]/div[3]/div[4]/span')  # 查找按钮
    search_name_loc = PageElement(xpath='//*[@id="root"]/div/div[2]/div[2]/div[3]/div[1]/div/input')  # 搜索课程名字
